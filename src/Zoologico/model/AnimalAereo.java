...
public abstract class AnimalAereo extends Animal {
    ...
    public AnimalAereo(String nome, String especie, int idade, double peso, double altura, double comprimento, String cor, int idAnimal, double alcanceMAxAltura, double tempoMaxVoo, double velocidadeMaxVoo) {
